...
a.preventDefault(),!1):!0},FastClick.prototype.onClick=function(a){return this.trackingClick?(this.targetElement=null,this.trackingClick=!1,!0):"submit"===a.target.type&&0===a.detail?!0:(a=this.onMouse(a),a||(this.targetElement=null),a)},FastClick.prototype.destroy=function(){var a=this.layer;deviceIsAndroid&&(a.removeEventListener("mouseover",this.onMouse,!0),a.removeEventListener("mousedown",this.onMouse,!0),a.removeEventListener("mouseup",this.onMouse,!0)),a.removeEventListener("click",this.onClick,!0),a.removeEventListener("touchstart",this.onTouchStart,!1),a.removeEventListener("touchmove",this.onTouchMove,!1),a.removeEventListener("touchend",this.onTouchEnd,!1),a.removeEventListener("touchcancel",this.onTouchCancel,!1)},FastClick.notNeeded=function(a){var b,c;if("undefined"==typeof window.ontouchstart)return!0;if(c=+(/Chrome\/([0-9]+)/.exec(navigator.userAgent)||[,0])[1]){if(!deviceIsAndroid)return!0;if((b=document.querySelector("meta[name=viewport]"))&&(-1!==b.content.indexOf("user-scalable=no")||c>31&&window.innerWidth<=window.screen.width))return!0}return"none"===a.style.msTouchAction?!0:!1},FastClick.attach=function(a){return new FastClick(a)},"undefined"!=typeof define&&define.amd?define(function(){return FastClick}):"undefined"!=typeof module&&module.exports?(module.exports=FastClick.attach,module.exports.FastClick=FastClick):window.FastClick=FastClick,String.prototype.toTitleCase=function(){var a=/^(a|an|and|as|at|but|by|en|for|if|in|nor|of|on|or|per|the|to|vs?\.?|via)$/i;return this.replace(/[A-Za-z0-9\u00C0-\u00FF]+[^\s-]*/g,function(b,c,d){return c>0&&c+b.length!==d.length&&b.search(a)>-1&&":"!==d.charAt(c-2)&&("-"!==d.charAt(c+b.length)||"-"===d.charAt(c-1))&&d.charAt(c-1).search(/[^\s-]/)<0?b.toLowerCase():b.substr(1).search(/[A-Z]|\../)>-1?b:b.charAt(0).toUpperCase()+b.substr(1)})},$(function(){function a(){var a=$(".provider-search-state");a.each(function(){"false"!==$(this).val()&&$(this).val("false")});for(var b in i)i[b].filter()}function b(){$("#provider .filter-by-last-name").addClass("hide"),$("#provider .no-results").addClass("hide"),$("#provider-list").html(""),$("#provider .total-listings").removeClass("in")}function c(a){var b=a.split("?");return b[0]}function d(a){var b,c,d,e,f={};for(b=a.split("&"),d=0,e=b.length;e>d;d++)c=b[d].split("="),f[c[0]]=c[1];return f}$("a.next-btn").smoothScroll();var e=!1;-1!=navigator.userAgent.indexOf("Mac OS X")&&(e=!0);var f=!1;window.history&&history.pushState&&(f=!0,window.addEventListener("popstate",function(a){window.location.hash.split("?")}));var g=function(a){if($.smoothScroll({scrollTarget:"#select-provider-wrapper"}),e){var b=$($(a).attr("href")).find(".provider-list");if(!b.length)return;setTimeout(function(){b[0].clientHeight<b[0].scrollHeight&&b.next().find(".scroll-hint").removeClass("no-show")},300)}};$("body").on("click","a.box-link-rapper",function(a,b){f&&!b&&history.pushState(null,"",window.location.pathname+this.hash),g(this)}),$("body").on("click","a.provider-link",function(a){if(f){var b=c(window.location.hash),d=$(this).parents(".providers").find(".provider-search-name").val();if(d.length)history.pushState(null,"",window.location.pathname+b+"?q="+d);else{var e=$(this).parents(".providers").find(".provider-search-state").val();e.length&&"false"!==e&&history.pushState(null,"",window.location.pathname+b+"?state="+e)}}});var h={listClass:"provider-list",searchClass:"provider-search-name",valueNames:["provider-link"]},i={insuranceList:new List("insurance-list-wrapper",h),physicianList:new List("physician-list-wrapper",h),pharmacyList:new List("pharmacy-list-wrapper",h),labList:new List("lab-list-wrapper",h),immunizationList:new List("immunization-list-wrapper",h)};$("body").on("input keychange",".provider-search-name",$.debounce(750,function(b){a();var c=$(this);c.closest(".tab-pane").attr("id")})),$("body").on("input keychange",".provider-search-zip",function(c){a();var d=$(this).val();5==d.length?$("#provider .provider-search-state").val("false"):b()}),$("body").on("change",".provider-search-state",function(a){var b=$(this),c=(b.closest(".tab-pane").attr("id"),b.val()),d=i[b.closest(".tab-pane").attr("id")+"List"];if("false"==c)return d.filter(),!1;var e=function(a){for(var b=$(a.elm).find("a").attr("data-state").split(","),d=b.length,e=!1,f=0;d>f;f++)if("all"===c||c==b[f]){e=!0;break}return e};return $("#physician-list-wrapper .provider-search-name").val(""),d.search(),d.filter(e),!1}),$("body").on("click","a.vid-still",function(a){var b=$(this),c=$("#vid-modal");return $("#vid-frame").data("yturl","//www.youtube.com/embed/"+b.data("ytid")+"?rel=0&theme=dark&modestbranding=0&color=white&controls=1&autohide=1&showinfo=0&hd=1&autoplay=1"),c.modal("show"),a.preventDefault(),!1}),$("#vid-modal").on("hidden.bs.modal",function(){$("#vid-frame").attr("src",""),$("#vid-modal").find(".modal-title").html("")}),$("#vid-modal").on("shown.bs.modal",function(){var a=$("#vid-frame");a.attr("src",a.data("yturl"))});var j=function(a){var b=a.next().find(".scroll-hint");a[0].scrollHeight-a.scrollTop()<a.outerHeight()+30?b.addClass("no-show"):b.removeClass("no-show")};if(e){var k;$(".provider-list").scroll(function(a){var b=$(this);k&&clearTimeout(k),k=setTimeout(function(){j(b)},200)})}if("/records/"===window.location.pathname&&window.location.hash.length){var l=window.location.hash.split("?"),m=$("a.box-link-rapper[href="+l[0]+"]");if(m.trigger("click",!0),l.length>1){var n=d(l[1]);n.q&&""!==n.q?($(m.attr("href")+"-list-wrapper").find(".provider-search-name").val(n.q),i[m.attr("href").substring(1)+"List"].search(n.q)):n.state&&""!==n.state?$(m.attr("href")+"-list-wrapper").find(".provider-search-state").val(n.state).trigger("change"):n.name&&""!==n.name&&$("#provider-list-wrapper").find(".provider-search-name").val(decodeURIComponent(n.name)).trigger("keychange")}}FastClick.attach(document.body)});